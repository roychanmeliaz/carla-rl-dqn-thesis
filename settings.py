...
# CARLA_PATH = '../CARLA_0.9.5'  # Path to Carla root folder
CARLA_PATH = "..\CARLA_0.9.5"  # Path to Carla root folder
# CARLA_PATH = "..\CARLA_0.9.11"  # Path to Carla root folder
...
# ACTIONS = ['forward', 'forward_left', 'forward_right']  # ['forward', 'left', 'right', 'forward_left', 'forward_right', 'backwards', 'backwards_left', 'backwards_right']
# Opt lengkap
ACTIONS = ['forward', 'left', 'right', 'forward_left', 'forward_right', 'brake']  # ['forward', 'left', 'right', 'forward_left', 'forward_right', 'backwards', 'backwards_left', 'backwards_right']
...
# AGENT_ADDITIONAL_DATA = []  # What additional data to include next to image data in observation space, possible values: kmh
...
MODEL_NAME = 'opt_lengkap_50throttle_notbunderan_segmented_64x3_#CNN_KERNELS#'  # model name, prefixed from sources/models.py, #MODEL_ARCHITECTURE# adds model architectore acronym, #CNN_KERNELS# adds number of kernels from all CNN layers
